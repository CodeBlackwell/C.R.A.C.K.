...
class InjectionAttacksPlugin(ServicePlugin):
    ...
    def detect(self, port_info: Dict[str, Any], profile: 'TargetProfile') -> float:
        """
        Detect web services for injection attack testing with confidence scoring

        This plugin provides injection testing (command, XPath, LDAP, email, CRLF, CSV, LaTeX, XSLT, phone).
