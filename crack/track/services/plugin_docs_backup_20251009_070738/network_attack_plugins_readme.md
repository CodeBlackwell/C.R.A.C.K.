# 🌐 Network Attack Service Plugins - Complete Reference

**Status:** ✅ Complete
**OSCP Relevance:** HIGH
**Last Updated:** 2025-10-07
**Plugin Sources:** [`../network_poisoning.py`](../network_poisoning.py) | [`../ipv6_attacks.py`](../ipv6_attacks.py)
...
### 2. [Network Poisoning Plugin](#1-network-poisoning-plugin-network_poisoningpy)
   - [Purpose](#purpose)
   - [Detection Triggers](#detection-triggers)
   - [Attack Phases](#attack-phases-5-major-categories)
   - [Phase Details](#phase-details)
   - [OSCP Value](#oscp-value)
   - [Key Commands](#key-commands)
   - [Test Coverage](#test-coverage)

### 3. [IPv6 Attacks Plugin](#2-ipv6-attacks-plugin-ipv6_attackspy)
   - [Purpose](#purpose-1)
   - [Detection Triggers](#detection-triggers-1)
   - [Attack Phases](#attack-phases-4-major-categories)
   - [Phase Details](#phase-details-1)
   - [OSCP Value](#oscp-value-1)
...
### 5. [OSCP Exam Relevance](#oscp-exam-relevance)
   - [Network Poisoning Strategy](#network-poisoning-plugin)
   - [IPv6 Attacks Strategy](#ipv6-attacks-plugin)

### 6. [Usage Examples](#usage-examples)
   - [Network Poisoning Example](#network-poisoning)
   - [IPv6 Attacks Example](#ipv6-attacks)

### 7. [Testing & Quality](#test-quality)
   - [Coverage Metrics](#coverage-metrics)
   - [Test Philosophy](#test-philosophy)

### 8. [Comparison](#comparison-to-existing-plugins)
   - [Code Size](#code-size)
   - [Educational Depth](#educational-depth)
...
|--------|-------|-------|-------|----------|
| **Network Poisoning** | 1,156 | 13 | 38 | LLMNR/NTLM/Kerberos |
| **IPv6 Attacks** | 1,012 | 13 | 39 | Recon/MitM/NDP |
| **Total** | 2,168 | 26 | 77 | 100% Pass Rate |
...
### Purpose
LLMNR/NBT-NS/mDNS/WPAD spoofing and NTLM/Kerberos relay attacks
...
### Purpose
IPv6 network reconnaissance, MitM, and exploitation
...
- [`../ldap.py`](../ldap.py) - LDAP enumeration (if exists)
...
**Impact:** OSCP students now have automated guidance for LLMNR/NBT-NS/WPAD poisoning, NTLM relay to SMB/LDAP, Kerberos relay attacks, IPv6 reconnaissance and MitM, DHCPv6 DNS poisoning (mitm6), and network defense enumeration
