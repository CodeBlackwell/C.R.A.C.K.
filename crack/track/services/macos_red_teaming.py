...
Exploitation:
- Zip containing malicious .pkg → Auto-decompressed
- .pkg with install scripts → May prompt or auto-run
- .app bundles → May execute if user clicks
