"""
Enumeration checklist CLI

Main command-line interface for the enumeration tracking system.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Target enumeration checklist and task tracker',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Start enumeration for target
  crack checklist 192.168.45.100

  # Import nmap scan results
  crack checklist 192.168.45.100 --import port_scan.xml
  crack checklist 192.168.45.100 --import service_scan.xml

  # Mark tasks complete
  crack checklist 192.168.45.100 --mark-done whatweb-80
  crack checklist 192.168.45.100 --mark-done gobuster-80

  # Add findings and notes
  crack checklist 192.168.45.100 --finding "SQLi in id parameter" --source "Manual testing"
  crack checklist 192.168.45.100 --note "Apache 2.4.41 has known RCE"

  # Add credentials
  crack checklist 192.168.45.100 --cred admin:password123 --service mysql --port 3306

  # Export reports
  crack checklist 192.168.45.100 --export report.md
  crack checklist 192.168.45.100 --export-commands commands.md

  # List all targets
  crack checklist --list

  # Reset target
  crack checklist 192.168.45.100 --reset
        """
    )
