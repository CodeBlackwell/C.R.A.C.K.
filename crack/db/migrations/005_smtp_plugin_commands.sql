...
VALUES
    ...
    ('smtp-banner-grab-25', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '25') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('smtp-banner-grab-25', '-v', 'Verbose output (shows connection details)'),
    ('smtp-banner-grab-25', '-n', 'Numeric IP addresses only (no DNS resolution - faster)') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('smtp-banner-grab-25', 'failure', 'Connection timeout', 'literal', 'Host unreachable') ON CONFLICT DO NOTHING;

INSERT INTO tags (name) VALUES ('OSCP:HIGH'), ('OSCP:MEDIUM'), ('OSCP:LOW'), ('QUICK_WIN'), ('MANUAL'), ('AUTOMATED'), ('CRITICAL'), ('ENUM'), ('EXPLOIT'), ('LINUX'), ('WINDOWS'), ('NOISY'), ('NSE'), ('POST_ACCESS'), ('REQUIRES_AUTH'), ('REQUIRES_SHELL'), ('RESEARCH'), ('QUICK_WIN'), ('MANUAL'), ('AUTOMATED'), ('ENUM'), ('WINDOWS'), ('NOISY')
ON CONFLICT (name) DO UPDATE SET
    category = EXCLUDED.category,
    description = EXCLUDED.description,
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('smtp-banner-grab-25', (SELECT id FROM tags WHERE name = 'MANUAL')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('smtp-banner-grab-465', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '465') ON CONFLICT (command_id, variable_id) DO NOTHING;
...
VALUES
    ...
    ('smtp-banner-grab-465', '-connect', 'Host:port to connect to') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('smtp-banner-grab-465', 'failure', 'Connection refused', 'literal', 'Service not available') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('smtp-banner-grab-465', (SELECT id FROM tags WHERE name = 'MANUAL')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('smtp-banner-grab-587', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '587') ON CONFLICT (command_id, variable_id) DO NOTHING;
...
VALUES
    ...
    ('smtp-banner-grab-587', '-connect', 'Host:port to connect to') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('smtp-banner-grab-587', 'failure', 'TLS upgrade failed', 'literal', 'Connection closed unexpectedly') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('smtp-banner-grab-587', (SELECT id FROM tags WHERE name = 'MANUAL')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('smtp-command-enum', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '25') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('smtp-command-enum', '-p', 'Target port'),
    ('smtp-command-enum', '--script smtp-commands', 'NSE script to enumerate SMTP commands via EHLO/HELP') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('smtp-command-enum', 'failure', 'Connection refused', 'literal', 'Service unavailable') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('smtp-command-enum', (SELECT id FROM tags WHERE name = 'OSCP:HIGH')),
    ('smtp-command-enum', (SELECT id FROM tags WHERE name = 'QUICK_WIN')),
    ('smtp-command-enum', (SELECT id FROM tags WHERE name = 'AUTOMATED')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('smtp-ntlm-info', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '25') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('smtp-ntlm-info', '-p', 'Target port'),
    ('smtp-ntlm-info', '--script smtp-ntlm-info', 'NSE script to extract NTLM info disclosure') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('smtp-ntlm-info', 'failure', 'Script failed', 'literal', 'Script execution error') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('smtp-ntlm-info', (SELECT id FROM tags WHERE name = 'WINDOWS')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('smtp-user-enum-vrfy', (SELECT id FROM variables WHERE name = '<WORDLIST>'), 3, TRUE, '/usr/share/wordlists/seclists/Usernames/top-usernames-shortlist.txt') ON CONFLICT (command_id, variable_id) DO NOTHING;
...
VALUES
    ...
    ('smtp-user-enum-vrfy', '-p', 'Target port number') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('smtp-user-enum-vrfy', 'failure', 'VRFY disabled', 'literal', 'Try RCPT or EXPN methods instead') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('smtp-user-enum-vrfy', (SELECT id FROM tags WHERE name = 'OSCP:HIGH')),
    ('smtp-user-enum-vrfy', (SELECT id FROM tags WHERE name = 'AUTOMATED')),
    ('smtp-user-enum-vrfy', (SELECT id FROM tags WHERE name = 'ENUM')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('smtp-user-enum-rcpt', (SELECT id FROM variables WHERE name = '<DOMAIN>'), 4, FALSE, 'example.com') ON CONFLICT (command_id, variable_id) DO NOTHING;
...
VALUES
    ...
    ('smtp-user-enum-rcpt', '-D', 'Domain to test (use target domain if known)') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('smtp-user-enum-rcpt', 'failure', 'All same responses', 'literal', 'Enumeration protection enabled') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('smtp-user-enum-rcpt', (SELECT id FROM tags WHERE name = 'OSCP:HIGH')),
    ('smtp-user-enum-rcpt', (SELECT id FROM tags WHERE name = 'AUTOMATED')),
    ('smtp-user-enum-rcpt', (SELECT id FROM tags WHERE name = 'ENUM')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('smtp-open-relay', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '25') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('smtp-open-relay', '-p', 'Target port'),
    ('smtp-open-relay', '--script smtp-open-relay', 'NSE script to test open relay configuration'),
    ('smtp-open-relay', '-v', 'Verbose output (shows test attempts)') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('smtp-open-relay', 'failure', '550 Relaying denied', 'literal', 'Explicit relay denial') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('smtp-open-relay', (SELECT id FROM tags WHERE name = 'OSCP:HIGH')),
    ('smtp-open-relay', (SELECT id FROM tags WHERE name = 'AUTOMATED')),
    ('smtp-open-relay', (SELECT id FROM tags WHERE name = 'ENUM')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('smtp-auth-brute', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '25') ON CONFLICT (command_id, variable_id) DO NOTHING;
...
VALUES
    ...
    ('smtp-auth-brute', '-v', 'Verbose output (show attempts)') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('smtp-auth-brute', 'failure', 'Account lockout', 'literal', 'Account locked from failed attempts') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('smtp-auth-brute', (SELECT id FROM tags WHERE name = 'OSCP:MEDIUM')),
    ('smtp-auth-brute', (SELECT id FROM tags WHERE name = 'AUTOMATED')),
    ('smtp-auth-brute', (SELECT id FROM tags WHERE name = 'NOISY')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('smtp-nmap-all-scripts', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '25') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('smtp-nmap-all-scripts', '--script smtp-*', 'Run all NSE scripts matching "smtp-*" pattern (wildcard)'),
    ('smtp-nmap-all-scripts', '-p', 'Target port') ON CONFLICT (command_id, flag) DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('smtp-nmap-all-scripts', (SELECT id FROM tags WHERE name = 'OSCP:HIGH')),
    ('smtp-nmap-all-scripts', (SELECT id FROM tags WHERE name = 'AUTOMATED')) ON CONFLICT (command_id, tag_id) DO NOTHING;
