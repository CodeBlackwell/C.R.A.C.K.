...
VALUES
    ...
    ('ssh-banner-grab', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '22') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('ssh-banner-grab', '-v', 'Verbose output (show connection details)'),
    ('ssh-banner-grab', '-n', 'No DNS resolution (faster, use IP directly)') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('ssh-banner-grab', 'failure', 'timeout', 'literal', 'Firewall blocking') ON CONFLICT DO NOTHING;

INSERT INTO tags (name) VALUES ('OSCP:HIGH'), ('OSCP:MEDIUM'), ('OSCP:LOW'), ('QUICK_WIN'), ('MANUAL'), ('AUTOMATED'), ('CRITICAL'), ('ENUM'), ('EXPLOIT'), ('LINUX'), ('WINDOWS'), ('NOISY'), ('NSE'), ('POST_ACCESS'), ('REQUIRES_AUTH'), ('REQUIRES_SHELL'), ('RESEARCH'), ('QUICK_WIN'), ('MANUAL'), ('NSE')
ON CONFLICT (name) DO UPDATE SET
    category = EXCLUDED.category,
    description = EXCLUDED.description,
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('ssh-banner-grab', (SELECT id FROM tags WHERE name = 'MANUAL')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('ssh2-enum-algos', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '22') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('ssh2-enum-algos', '--script ssh2-enum-algos', 'NSE script to enumerate SSH2 algorithms'),
    ('ssh2-enum-algos', '-p', 'Target SSH port') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('ssh2-enum-algos', 'failure', 'Connection refused', 'literal', 'Port closed') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('ssh2-enum-algos', (SELECT id FROM tags WHERE name = 'OSCP:HIGH')),
    ('ssh2-enum-algos', (SELECT id FROM tags WHERE name = 'NSE')),
    ('ssh2-enum-algos', (SELECT id FROM tags WHERE name = 'QUICK_WIN')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('ssh-hostkey', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '22') ON CONFLICT (command_id, variable_id) DO NOTHING;
...
VALUES
    ...
    ('ssh-hostkey', '-p', 'Target SSH port') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('ssh-hostkey', 'failure', 'No keys extracted', 'literal', 'Extraction failed') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('ssh-hostkey', (SELECT id FROM tags WHERE name = 'QUICK_WIN')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('ssh-auth-methods', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '22') ON CONFLICT (command_id, variable_id) DO NOTHING;
...
VALUES
    ...
    ('ssh-auth-methods', '-p', 'Target SSH port') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('ssh-auth-methods', 'failure', 'Connection refused', 'literal', 'Port closed') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('ssh-auth-methods', (SELECT id FROM tags WHERE name = 'OSCP:HIGH')),
    ('ssh-auth-methods', (SELECT id FROM tags WHERE name = 'NSE')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('sshv1-detect', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '22') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('sshv1-detect', '--script sshv1', 'NSE script to test for SSHv1 support'),
    ('sshv1-detect', '-p', 'Target SSH port') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('sshv1-detect', 'failure', 'Unable to determine', 'literal', 'Detection inconclusive') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('sshv1-detect', (SELECT id FROM tags WHERE name = 'OSCP:MEDIUM')),
    ('sshv1-detect', (SELECT id FROM tags WHERE name = 'NSE')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('ssh-audit', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '22') ON CONFLICT (command_id, variable_id) DO NOTHING;

INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('ssh-audit', '-p', 'Target port') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('ssh-audit', 'failure', 'Tool not installed', 'literal', 'ssh-audit missing') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('ssh-audit', (SELECT id FROM tags WHERE name = 'QUICK_WIN')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('ssh-user-enum-msf', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '22') ON CONFLICT (command_id, variable_id) DO NOTHING;
...
VALUES
    ...
    ('ssh-user-enum-msf', 'USER_FILE', 'List of usernames to test') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('ssh-user-enum-msf', 'failure', 'Version not vulnerable', 'literal', 'OpenSSH >= 7.7') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('ssh-user-enum-msf', (SELECT id FROM tags WHERE name = 'AUTOMATED')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('ssh-badkeys-test', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '22') ON CONFLICT (command_id, variable_id) DO NOTHING;
...
VALUES
    ...
    ('ssh-badkeys-test', 'whoami', 'Simple command to verify access') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('ssh-badkeys-test', 'failure', 'No matching keys found', 'literal', 'No vulnerable keys') ON CONFLICT DO NOTHING;

INSERT INTO command_tags (command_id, tag_id) VALUES
    ('ssh-badkeys-test', (SELECT id FROM tags WHERE name = 'OSCP:MEDIUM')),
    ('ssh-badkeys-test', (SELECT id FROM tags WHERE name = 'QUICK_WIN')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('ssh-debian-keys-test', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '22') ON CONFLICT (command_id, variable_id) DO NOTHING;
...
VALUES
    ...
    ('ssh-debian-keys-test', '2>/dev/null', 'Suppress error messages') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('ssh-debian-keys-test', 'failure', 'System not vulnerable', 'literal', 'No weak keys') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('ssh-debian-keys-test', (SELECT id FROM tags WHERE name = 'LINUX')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('ssh-hydra-bruteforce', (SELECT id FROM variables WHERE name = '<PORT>'), 2, TRUE, '22') ON CONFLICT (command_id, variable_id) DO NOTHING;
...
VALUES
    ...
    ('ssh-hydra-bruteforce', '-V', 'Verbose (show each attempt)') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('ssh-hydra-bruteforce', 'failure', 'All attempts failed', 'literal', 'No valid credentials') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('ssh-hydra-bruteforce', (SELECT id FROM tags WHERE name = 'NOISY')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
INSERT INTO command_flags (command_id, flag, explanation)
VALUES
    ('ssh-searchsploit', '<VERSION>', 'SSH version from banner') ON CONFLICT (command_id, flag) DO NOTHING;
...
VALUES
    ...
    ('ssh-searchsploit', 'failure', 'Version too new', 'literal', 'No public exploits') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('ssh-searchsploit', (SELECT id FROM tags WHERE name = 'RESEARCH')) ON CONFLICT (command_id, tag_id) DO NOTHING;
...
VALUES
    ...
    ('ssh-config-analysis', 'failure', 'Permission denied', 'literal', 'Insufficient access') ON CONFLICT DO NOTHING;
...
INSERT INTO command_tags (command_id, tag_id) VALUES
    ...
    ('ssh-config-analysis', (SELECT id FROM tags WHERE name = 'REQUIRES_SHELL')) ON CONFLICT (command_id, tag_id) DO NOTHING;
