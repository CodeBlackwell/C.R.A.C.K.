...
from crack.enumeration.parsers.registry import ParserRegistry
from crack.enumeration.recommendations.engine import RecommendationEngine
...
class TestUserStory5_GenerateReport:
    ...
    def test_export_markdown_includes_all_data(
        ...
        # Export report
        from crack.enumeration.formatters.markdown import MarkdownFormatter
