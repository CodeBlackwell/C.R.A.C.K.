```bash
curl -sSik http://192.168.145.49:80/
```

[/home/kali/OSCP/capstones/chapter_10_capstone_3/results/192.168.145.49/scans/tcp80/tcp_80_http_curl.html](file:///home/kali/OSCP/capstones/chapter_10_capstone_3/results/192.168.145.49/scans/tcp80/tcp_80_http_curl.html):

```
HTTP/1.1 200 OK
Date: Wed, 01 Oct 2025 17:50:42 GMT
    ...
    <div class="container-fluid p-0 nav-bar">
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            <a href="" class="navbar-brand">
                <h1 class="m-0 display-4 font-weight-bold text-uppercase text-white">Golden Glove</h1>
            </a>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        ...
                        <a href="class.php" class="btn btn-lg btn-outline-light mt-3 mt-md-5 py-md-3 px-md-5">Join Us Now</a>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        ...
                        <a href="contact.php" class="btn btn-lg btn-outline-light mt-3 mt-md-5 py-md-3 px-md-5">Join Us Now</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row px-3">
            <div class="col-md-6 p-0">
                <div class="gym-class-box d-flex flex-column align-items-end justify-content-center bg-primary text-right text-white py-5 px-5">
                    ...
                    <a href="class.php" class="btn btn-lg btn-outline-light mt-4 px-4">Join Now</a>
                </div>
            </div>
            <div class="col-md-6 p-0">
                <div class="gym-class-box d-flex flex-column align-items-start justify-content-center bg-secondary text-left text-white py-5 px-5">
                    ...
                    <a href="contact.php" class="btn btn-lg btn-outline-light mt-4 px-4">Join Now</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container py-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <a href="about.php" class="btn btn-lg px-4 btn-outline-primary">Learn More</a>
            </div>
        </div>
    </div>
    <!-- About End -->
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        <h4 class="card-title text-primary">Owen</h4>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        <h4 class="card-title text-primary">Mikhail</h4>
                        <p class="card-text">Trainer</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        <h4 class="card-title text-primary">Melih</h4>
                        <p class="card-text">Trainer</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        <h4 class="card-title text-primary">Daniel</h4>
                        <p class="card-text">Trainer</p>
                    </div>
                </div>
            </div>
    ...
    <div class="footer container-fluid mt-5 py-5 px-sm-3 px-md-5 text-white">
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white mb-2" href="feature.php"><i class="fa fa-angle-right mr-2"></i>Our Features</a>
        ...
        <div class="container border-top border-dark pt-5">
            <p class="m-0 text-center text-white">
                &copy; <a class="text-white font-weight-bold" href="#">Golden Glove</a>. All Rights Reserved. Designed by
